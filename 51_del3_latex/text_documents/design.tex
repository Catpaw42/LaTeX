...
\centering
\noindent \includegraphics[width=\linewidth]{Robustnessdiagram1}
...
\centering
\noindent \includegraphics[width=\linewidth]{Classdiagram1}
...
\begin{figure}[h]
\centering
\noindent \includegraphics[width=\linewidth]{DesignSequenceDiagram}
\caption{\emph{Sekvensdiagram 1}: Play Game.}
\end{figure}
\FloatBarrier
\begin{figure}[h]
\centering
\noindent \includegraphics[width=\linewidth]{Sequencediagram3}
